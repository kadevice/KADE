...
*
* Mappings: (Ref) Direction: KeyDown/KeyUp
* (1) Up: W/E
* (2) Down: X/Z
* (3) Left: A/Q
* (4) Right: D/C
...
* (7) Button 3:U/F
* (8) Button 4:J/N
* (9) Button 5 (Left Bumper): I/M
* (0) Button 6 (Right Bumper): K/P
* (E1) Button 7 (Left Trigger): O/G
* (E2) Button 8 (Right Trigger): L/V
* 
* Pairing Mode:
* This mode is engaged by holding the bottom row of buttons along with the top right button.
* (6) + (8) + (0) + (E1) + (E2) 
*/
