...
#define _DESCRIPTORS_H_
    ...
    /* Macros: */
		...
		enum
		{
			HID_REPORTID_JoystickReport  = 0x01,
			HID_REPORTID_KeyboardReport  = 0x02,
			HID_REPORTID_JoystickReport2 = 0x03,
			HID_REPORTID_JoystickReport3 = 0x04,
			HID_REPORTID_JoystickReport4 = 0x05,
		} HID_Report_IDs;
